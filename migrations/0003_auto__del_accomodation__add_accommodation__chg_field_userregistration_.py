...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'registration_accommodation', (
        ...
        db.send_create_signal(u'registration', ['Accommodation'])


        # Changing field 'UserRegistration.accomodation'
        db.alter_column(u'registration_userregistration', 'accomodation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Accommodation'], null=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'registration_accommodation')


        # Changing field 'UserRegistration.accomodation'
        db.alter_column(u'registration_userregistration', 'accomodation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Accomodation'], null=True))
    ...
    models = {
        ...
        u'registration.userregistration': {
            ...
            'accomodation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['registration.Accommodation']", 'null': 'True', 'blank': 'True'}),
